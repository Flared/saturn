...
async def test_periodic_topic(event_loop: TimeForwardLoop, frozen_time: t.Any) -> None:
    ...
    async with alib.scoped_iter(topic.run()) as scoped_topic_iter:
        ...
        assert items == [
            TopicMessage(id="1514851500.0", args={}),
            TopicMessage(id="1514851800.0", args={}),
            TopicMessage(id="1514852100.0", args={}),
            TopicMessage(id="1514852400.0", args={}),
            TopicMessage(id="1514852700.0", args={}),
        ]
